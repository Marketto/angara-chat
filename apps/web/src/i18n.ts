...
const messages = {
  it: {
    ...
    available: 'Disponibile', newChat: 'Nuova chat', notifications: 'Abilita notifiche', repairNotifications: 'Ripara notifiche', conversations: 'Conversazioni', encryptedMessage: 'Messaggio crittografato', startWriting: 'Inizia a scrivere…', empty: 'Nessuna conversazione. Scegli una persona dalla rubrica.',
  ...
  en: {
    ...
    available: 'Available', newChat: 'New chat', notifications: 'Enable notifications', repairNotifications: 'Repair notifications', conversations: 'Conversations', encryptedMessage: 'Encrypted message', startWriting: 'Start writing…', empty: 'No conversations yet. Choose someone from your contacts.',
  ...
  ru: {
    ...
    available: 'Доступен', newChat: 'Новый чат', notifications: 'Включить уведомления', repairNotifications: 'Исправить уведомления', conversations: 'Диалоги', encryptedMessage: 'Зашифрованное сообщение', startWriting: 'Начните писать…', empty: 'Пока нет диалогов. Выберите человека из контактов.',
